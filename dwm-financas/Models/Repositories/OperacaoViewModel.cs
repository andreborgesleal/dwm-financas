...
{
    public abstract class OperacaoViewModel<OP, OPE> : Repository
        where OP : OperacaoParcelaViewModel<OPE>
        where OPE : OperacaoParcelaEventoViewModel
    {
        [DisplayName("ID")]
        ...
        public virtual OP OperacaoParcela { get; set; }

        public virtual IEnumerable<OP> OperacaoParcelas { get; set; }
    }
}